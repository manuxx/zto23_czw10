...
namespace Training.DomainClasses
{
    public class PetShop
    {
        ...
        {
            return _petsInTheStore.ThatSatisfy(Pet.IsASpeciesOf(Species.Mouse).Not());
        }
        ...
        {
            return _petsInTheStore.ThatSatisfy(Pet.IsASpeciesOf(Species.Dog).And(Pet.IsFemale().Not()));
        }
